            ...
            <ul class="menu-inner py-1">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item active">
                            <a href="" class="menu-link">
                                <div class="text-truncate" data-i18n="Analytics">Create To Du list</div>
                            </a>
                        </li>
                        <li class="menu-item active">
                            <a href="" class="menu-link">
                                <div class="text-truncate" data-i18n="Analytics">Create User</div>
                            </a>
                        </li>
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <div class="text-truncate" data-i18n="Layouts">Select</div>
                    </a>

                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="user_list" class="menu-link">
                                <div class="text-truncate" data-i18n="Without menu">User List</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="layouts-without-navbar.html" class="menu-link">
                                <div class="text-truncate" data-i18n="Without navbar">To Do List</div>
                            </a>
                        </li>
                        <li class="menu-item">
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <span class="d-flex align-items-center align-middle">
                          ...
                          <span class="flex-shrink-0 badge rounded-pill bg-danger">4</span>
                                ...
                                <li>
                                    <a class="dropdown-item" onclick="submitPostForm()">
                                        <i class="bx bx-power-off bx-md me-3"></i><span>Log Out</span>
                                    </a>
                                    {{--                                    <form action="logout" method="post" class="dropdown-item">--}}
                                    {{--                                        @csrf--}}
                                    {{--                                        <i class="bx bx-power-off bx-md me-3"></i> <input type="submit" value="logout" >--}}
                                    {{--                                    </form>--}}
                                </li>
                            </ul>
                        </li>
...
<script>
    function submitPostForm() {
        ...
        form.method = 'POST';
        form.action = 'http://127.0.0.1:8000/logout';  // Укажите URL для отправки POST-запроса

// Добавление CSRF токена
        var csrfTokenInput = document.createElement('input');
        csrfTokenInput.type = 'hidden';
        csrfTokenInput.name = '_token';
        csrfTokenInput.value = '{{ csrf_token() }}';  // Вставка CSRF токена из Laravel
        form.appendChild(csrfTokenInput);

// Добавление других данных в форму (если нужно)
        var input = document.createElement('input');
        input.type = 'hidden';
        input.name = 'exampleData';
